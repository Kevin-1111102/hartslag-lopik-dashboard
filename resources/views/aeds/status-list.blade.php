                    ...
                    <div class="list-group" id="aedListMobile">
                        @forelse($aeds as $aed)
                            <div class="list-group-item aed-item mb-2 rounded shadow-sm">
                                ...
                                <p class="mb-1">
                                    <strong>Eigenaar:</strong> {{ $aed->eigenaar }}
                                </p>

                                <p class="mb-1">
                                    <strong>Serienummer:</strong> {{ $aed->serienummer_aed ?? '-' }}
                                </p>

                                <p class="mb-1">
                                    <strong>Locatie:</strong> {{ $aed->adres }} {{ $aed->huisnummer }}
                                </p>

                                @if(!empty($aedDateLabel))
                                    <p class="mb-2">
                                        <strong>{{ $aedDateLabel }}:</strong> {{ $dateFieldValue ? $dateFieldValue($aed) : '-' }}
                                    </p>
                                @endif

                                <div class="d-grid gap-2">
                                    <a href="{{ route('aeds.show', $aed) }}" class="btn btn-outline-primary btn-sm">
                                        <i class="bi bi-eye me-1"></i>details
                                    </a>
                                    <a href="{{ route('aeds.controle.show', $aed) }}" class="btn btn-outline-success btn-sm">
                    ...
                    <div class="mb-4">
                        <div class="input-group">
                            ...
                            <input
                                ...
                                class="form-control"
                                id="searchDesktop"
                                placeholder="Zoek op eigenaar, adres of plaats..."
                                onkeyup="filterAeds()">
                        </div>
                    </div>
                                ...
                                <div class="card h-100 shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text mb-2">
                                            <strong>Locatie:</strong> {{ $aed->adres }} {{ $aed->huisnummer }}, {{ $aed->plaats }}
                                        </p>
